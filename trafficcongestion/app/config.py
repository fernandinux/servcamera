...
LAPSE_DAY   = 1
MAX_WEEK    = 4
END_DAY     = MAX_WEEK*LAPSE_DAY
SECONDS_DELAY       = 5
LIMIT_CONGESTION    = 10 
LIMIT_INTERVAL_TIME = 65
...
AMQP_URL        = 'amqp://root:winempresas@10.23.63.64:5672/%2F'
EXCHANGE_IN     = 'objs_Congestion'
QUEUE_IN        = 'trafficCongestion'
...
# parameters log 
FILE_NAME_LOG   = 'traffic_congestion'
