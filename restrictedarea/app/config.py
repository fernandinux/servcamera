...
# Nuevo: Nombre del contenedor Redis para las zonas (key)
REDIS_ZONES_CONTAINER = "restricted_area"  # Nombre del contenedor hash en Redis

MAX_QUEUE_SIZE = 100
PREFETCH_COUNT = 4

# Umbral de permanencia en segundos
PERMANENCE_THRESHOLD = 10  # Tiempo mínimo para generar una alerta de permanencia

# Resolución de la cámara (ajustar según tu cámara real)
CAMERA_RESOLUTION = (1920, 1080)  # (ancho, alto)

# Parámetros de la máscara
MASK_LOWER_PERCENTAGE = 0.35  # Porcentaje inferior del vehículo a considerar
