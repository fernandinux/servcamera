...
# Variables nuevas JSON PARAMETERS
DATA_FOV_H      = 'fov_h_deg' 
DATA_FOV_V      = 'fov_v_deg' 
DATA_CAM_HEIGHT = 'cam_height'
DATA_ROTATION   = 'rotation' 
DATA_INCLINATION= 'inclination'
DATA_LIMIT_SPEED= 'limit_speed'

# parameters log 
FILE_NAME_LOG   = 'average_speed'
